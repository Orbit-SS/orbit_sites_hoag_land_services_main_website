          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href={PHONE_HREF}
                  className="flex items-center gap-2 text-sm text-white/50 hover:text-[#5d9c70] transition-colors duration-200"
                >
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-white/5 hover:bg-[#4a7c59]/20 flex items-center justify-center text-white/40 hover:text-[#5d9c70] transition-all duration-200"
                aria-label="Facebook"
              >
