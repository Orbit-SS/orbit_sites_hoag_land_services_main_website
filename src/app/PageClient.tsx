        ...
        <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
          {items.map((item) => (
            <div key={item.label} className="flex items-center gap-2">
              ...
              {item.icon === 'shield' && (
                <svg className="w-5 h-5 text-[#5d9c70]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {cards.map((card) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <span className="inline-flex items-center gap-1 text-[#5d9c70] text-sm font-semibold uppercase tracking-wider group-hover:gap-2 transition-all duration-200">
                  View Services
          ...
          {REVIEWS.map((review) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[#4a7c59]/20 flex items-center justify-center text-[#5d9c70] font-bold text-sm">
