        ...
        <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
          {items.map((item) => (
            <div key={item.label} className="flex items-center gap-2">
              ...
              {item.icon === 'shield' && (
                <svg className="w-5 h-5 text-[#579269]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {cards.map((card) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <span className="inline-flex items-center gap-1 text-[#579269] text-sm font-semibold uppercase tracking-wider group-hover:gap-2 transition-all duration-200">
                  View Services
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-2 border-2 border-[#4a7c59] text-[#579269] hover:bg-[#4a7c59] hover:text-white px-6 py-3 rounded-lg text-sm font-bold uppercase tracking-wider transition-all duration-200"
            >
              Learn More
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
          ...
          {REVIEWS.map((review) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[#4a7c59]/20 flex items-center justify-center text-[#579269] font-bold text-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {AREA_LINKS.map(a => (
            ...
            >
              ...
              <svg className="w-4 h-4 text-[#579269] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
