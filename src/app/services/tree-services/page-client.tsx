    ...
    <div className="min-h-screen bg-[#1a1c1a] text-white font-sans">
      ...
      <section className="bg-[#141614] py-16 px-4 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          <p className="text-[#c2a878] font-display uppercase tracking-[0.2em] text-sm mb-3">
            Local Tree Service Focus
          </p>
          <h2 className="font-display text-3xl md:text-4xl font-bold uppercase mb-4">
            Port Orange and DeLand Tree Removal, Trimming, and Stump Grinding
          </h2>
          <p className="text-gray-400 leading-relaxed max-w-3xl mb-8">
            Hoag Land Services handles tree removal, trimming, storm cleanup, and stump grinding across Volusia
            County with ISA Certified Arborist oversight. Use the local pages below for the most relevant service-area
            details before calling for a free estimate.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/services/tree-services/port-orange"
              className="inline-flex items-center justify-center bg-[#4a7c59] hover:bg-[#3d6a4b] text-white font-display uppercase font-bold tracking-wider px-8 py-4 transition-colors"
            >
              Port Orange Tree Service
            </Link>
            <Link
              href="/services/tree-services/deland"
