...
export default function TreeServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1a1c1a] text-white font-sans">
      ...
      <section className="relative min-h-[600px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-20 md:py-28">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-wide leading-tight max-w-3xl">
            Tree Service in DeLand &amp;<br />Central Florida
          </h1>
          <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-2xl leading-relaxed">
            ISA Certified Arborist tree removal, trimming, palm pruning, storm cleanup,
            and hazardous tree assessment across DeLand, Volusia, Flagler, and Lake counties.
          </p>
      ...
      {/* ═══════════════════════════════════════════
          2B. WHAT'S INCLUDED IN TREE SERVICE (subservice cluster)
          ═══════════════════════════════════════════ */}
      <section className="bg-[#0d0f0d] py-16 px-4 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold uppercase text-center mb-4">
            What&rsquo;s Included in Our Tree Service
          </h2>
          <p className="text-gray-400 text-center max-w-2xl mx-auto mb-12">
            One ISA Certified Arborist crew, everything on a tree in one call. Here is what we handle.
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { name: 'Tree Removal', href: '/services/tree-services/tree-removal', tag: 'Hazardous, storm, or unwanted trees' },
              { name: 'Tree Trimming', href: '/services/tree-services/tree-trimming', tag: 'Deadwood, clearance, structural pruning' },
              { name: 'Palm Pruning', href: '/services/tree-services/palm-pruning', tag: 'Sabal, Washingtonia, queen palms' },
      ...
      <section className="bg-[#1a1c1a] py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold uppercase mb-14">
            Tree Services in DeLand &amp; Volusia County
          </h2>
                ...
                <div className="md:w-1/2">
                  <div className="relative h-64 md:h-80 overflow-hidden">
                    <Image
                      ...
                      alt={`${item.name} by an ISA Certified Arborist in Central Florida`}
                      fill
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-[#1a1c1a] border border-white/5 p-4 text-center">
                  <p className="font-display text-2xl font-bold text-[#5d9c70]">ISA</p>
                  <p className="text-gray-400 text-xs uppercase tracking-wider mt-1">Certified</p>
                </div>
                <div className="bg-[#1a1c1a] border border-white/5 p-4 text-center">
                  <p className="font-display text-2xl font-bold text-[#5d9c70]">TRAQ</p>
      ...
      {/* ═══════════════════════════════════════════
          5B. MOST SEARCHED IN TREE SERVICES (city cluster links)
          ═══════════════════════════════════════════ */}
      <section className="bg-[#0d0f0d] py-16 px-4 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <p className="text-[#c2a878] font-display uppercase tracking-[0.2em] text-sm mb-3 text-center">
            Most Searched in Tree Services
          </p>
          <h2 className="font-display text-3xl font-bold uppercase text-center mb-10">
            Tree Service Pages Across Central Florida
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 text-sm">
            {[
              { text: 'Tree Service in Port Orange, FL', href: '/services/tree-services/port-orange' },
              { text: 'Tree Service in DeLand', href: '/services/tree-services/deland' },
              { text: 'Tree Service in Daytona Beach', href: '/services/tree-services/daytona-beach' },
              { text: 'Tree Service in Ormond Beach', href: '/services/tree-services/ormond-beach' },
              { text: 'Tree Service in New Smyrna Beach', href: '/services/tree-services/new-smyrna-beach' },
              { text: 'Tree Service in Palm Coast', href: '/services/tree-services/palm-coast' },
            ].map((l) => (
              <Link
                key={l.href}
                href={l.href}
