  ...
  return (
    <div className="bg-[#1a1c1a] text-gray-100 min-h-screen">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Overgrown Trees', url: '/services/tree-services/overgrown-trees' },
      ]} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative rounded-lg w-full h-64 overflow-hidden">
                <Image
                  src={IMAGES.tree7}
                  alt="Professional tree trimming and canopy reduction"
                  fill
              ...
              <div className="relative rounded-lg w-full h-64 mt-8 overflow-hidden">
                <Image
                  src={IMAGES.tree11}
                  alt="Overgrown tree pruning in DeLand FL"
                  fill
                  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                  className="object-cover"
                />
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <Link href="/services/tree-services/tree-trimming" className="group bg-[#141614] border border-white/5 rounded-lg p-6 hover:border-[#4a7c59]/30 transition-colors text-center">
              <h3 className="font-display text-lg font-bold uppercase text-white mb-2 group-hover:text-[#579269] transition-colors">Tree Trimming</h3>
            ...
            <Link href="/services/tree-services/dangerous-trees" className="group bg-[#141614] border border-white/5 rounded-lg p-6 hover:border-[#4a7c59]/30 transition-colors text-center">
              <h3 className="font-display text-lg font-bold uppercase text-white mb-2 group-hover:text-[#579269] transition-colors">Dangerous Trees</h3>
            ...
            <Link href="/services/tree-services/wrong-tree-wrong-place" className="group bg-[#141614] border border-white/5 rounded-lg p-6 hover:border-[#4a7c59]/30 transition-colors text-center">
              <h3 className="font-display text-lg font-bold uppercase text-white mb-2 group-hover:text-[#579269] transition-colors">Wrong Tree, Wrong Place</h3>
