  ...
  return (
    <div className="bg-[#1a1c1a] text-gray-100 min-h-screen">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Palm Pruning', url: '/services/tree-services/palm-pruning' },
      ]} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative rounded-lg w-full h-64 overflow-hidden">
                <Image
                  src={IMAGES.tree14}
                  alt="Palm pruning by Hoag Land Services"
                  fill
              ...
              <div className="relative rounded-lg w-full h-64 mt-8 overflow-hidden">
                <Image
                  src={IMAGES.tree15}
                  alt="Professional palm maintenance in Central Florida"
                  fill
                  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                  className="object-cover"
                />
      ...
      <SpecialtyAreaLinks service="tree" specialty="Palm Pruning" />
    </div>
  )
}
