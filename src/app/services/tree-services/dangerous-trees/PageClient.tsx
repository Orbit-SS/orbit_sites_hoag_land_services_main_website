  ...
  return (
    <div className="bg-[#1a1c1a] text-gray-100 min-h-screen">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Dangerous Trees', url: '/services/tree-services/dangerous-trees' },
      ]} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative rounded-lg w-full h-64 overflow-hidden">
                <Image
                  src={IMAGES.tree2}
                  alt="Hazard tree assessment by certified arborist"
                  fill
              ...
              <div className="relative rounded-lg w-full h-64 mt-8 overflow-hidden">
                <Image
                  src={IMAGES.tree9}
                  alt="Safe hazard tree removal in DeLand FL"
                  fill
                  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                  className="object-cover"
                />
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <Link href="/services/tree-services/storm-damage" className="group bg-[#141614] border border-white/5 rounded-lg p-6 hover:border-[#4a7c59]/30 transition-colors text-center">
              <h3 className="font-display text-lg font-bold uppercase text-white mb-2 group-hover:text-[#579269] transition-colors">Storm Damage</h3>
      ...
      <SpecialtyAreaLinks service="tree" specialty="Hazardous Tree Removal" />
    </div>
  )
}
