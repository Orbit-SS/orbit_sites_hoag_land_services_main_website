  ...
  return (
    <main className="bg-[#1a1c1a] text-gray-100">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Fence Replacement', url: '/services/fencing/fence-replacement' },
      ]} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative rounded-lg w-full h-48 col-span-2 overflow-hidden">
                <Image
                  src={IMAGES.fence6}
                  alt="Completed fence replacement"
                  fill
      ...
      <SpecialtyAreaLinks service="fence" specialty="Fence Replacement" />
    </main>
  )
}
