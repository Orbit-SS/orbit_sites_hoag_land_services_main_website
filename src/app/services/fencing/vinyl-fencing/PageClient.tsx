  ...
  return (
    <main className="bg-[#1a1c1a] text-gray-100">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Vinyl Fencing', url: '/services/fencing/vinyl-fencing' },
      ]} />
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="relative rounded-lg w-full h-56 overflow-hidden">
                <Image
                  src={IMAGES.fence7}
                  alt="Vinyl privacy fence installation"
                  fill
              ...
              <div className="relative rounded-lg w-full h-56 overflow-hidden">
                <Image
                  src={IMAGES.fence8}
                  alt="Vinyl fence project in Central Florida"
                  fill
                  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                  className="object-cover"
                />
      ...
      <SpecialtyAreaLinks service="fence" specialty="Vinyl Fencing" />
    </main>
  )
}
