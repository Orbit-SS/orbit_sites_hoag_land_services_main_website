  ...
  return (
    <main className="bg-[#1a1c1a] text-gray-100">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Livestock Containment', url: '/services/fencing/livestock-containment' },
      ]} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative rounded-lg w-full h-48 overflow-hidden">
                <Image
                  src={IMAGES.fence8}
                  alt="Board fence for horse property"
                  fill
                  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                  className="object-cover"
                />
              ...
              <div className="relative rounded-lg w-full h-48 col-span-2 overflow-hidden">
                <Image
                  src={IMAGES.fence3}
                  alt="Livestock containment fencing"
                  fill
      ...
      <SpecialtyAreaLinks service="fence" specialty="Livestock Fencing" />
    </main>
  )
}
