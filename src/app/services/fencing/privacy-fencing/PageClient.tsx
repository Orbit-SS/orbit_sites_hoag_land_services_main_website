  ...
  return (
    <main className="bg-[#1a1c1a] text-gray-100">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Privacy Fencing', url: '/services/fencing/privacy-fencing' },
      ]} />

      {/* ── Hero ── */}
      <section className="relative min-h-[70vh] flex items-center">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(/photos/hoag/privacy-fence-lake-house-volusia.jpeg)` }} />
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <img src="/photos/hoag/privacy-fence-lake-house-volusia.jpeg" alt="Fresh wood privacy fence installed at a Volusia County lake house by Hoag Land Services" className="rounded-lg w-full h-48 object-cover" />
              <img src="/photos/hoag/privacy-fence-dog-pen-deland.jpeg" alt="Custom wood privacy fence enclosing a DeLand backyard dog area" className="rounded-lg w-full h-48 object-cover" />
