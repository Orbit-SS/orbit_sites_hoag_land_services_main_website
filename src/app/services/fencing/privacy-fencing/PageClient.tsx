          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative rounded-lg w-full h-48 overflow-hidden">
                <Image
                  src="/photos/hoag/privacy-fence-lake-house-volusia.jpeg"
                  alt="Fresh wood privacy fence installed at a Volusia County lake house by Hoag Land Services"
                  fill
              ...
              <div className="relative rounded-lg w-full h-48 overflow-hidden">
                <Image
                  src="/photos/hoag/privacy-fence-dog-pen-deland.jpeg"
                  alt="Custom wood privacy fence enclosing a DeLand backyard dog area"
                  fill
                  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                  className="object-cover"
                />
              ...
              <div className="relative rounded-lg w-full h-48 col-span-2 overflow-hidden">
                <Image
                  src={IMAGES.fence5}
                  alt="Completed privacy fence project"
                  fill
