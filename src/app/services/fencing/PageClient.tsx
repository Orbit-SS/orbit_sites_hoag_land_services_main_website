            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-[#1a1c1a] border border-white/5 p-4 text-center">
                  <p className="font-display text-2xl font-bold text-[#579269]">{new Date().getFullYear() - EST_YEAR}+</p>
                ...
                <div className="bg-[#1a1c1a] border border-white/5 p-4 text-center">
                  <p className="font-display text-2xl font-bold text-[#579269]">3</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div>
                <h3 className="font-display text-lg font-bold uppercase mb-1 group-hover:text-[#579269] transition-colors">
                  Site Work
                </h3>
                <p className="text-gray-400 text-sm">
