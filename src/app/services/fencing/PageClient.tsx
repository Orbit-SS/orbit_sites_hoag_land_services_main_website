...
function ClearLineIcon() {
  return (
    <svg className="w-10 h-10 text-[#5d9c70]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-[#1a1c1a] text-white font-sans">
      ...
      <section className="relative min-h-[600px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-20 md:py-28">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-wide leading-tight max-w-3xl">
            Fence Contractor in<br />DeLand &amp; Central Florida
          </h1>
          <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-2xl leading-relaxed">
            Wood, vinyl, aluminum, privacy, farm, and property-boundary fencing for homes,
            ranches, and commercial properties across Volusia, Lake, and Flagler counties.
          </p>
      ...
      {/* ═══════════════════════════════════════════
          2B. WHAT'S INCLUDED IN FENCING (subservice cluster)
          ═══════════════════════════════════════════ */}
      <section className="bg-[#0d0f0d] py-16 px-4 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-center max-w-2xl mx-auto mb-12">
            Six fence types, one crew, one estimate. Residential, agricultural, and commercial.
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { name: 'Wood Fencing', href: '/services/fencing/wood-fencing', tag: 'Board, split-rail, barbed wire, horse fence' },
              { name: 'Vinyl Fencing', href: '/services/fencing/vinyl-fencing', tag: 'Low-maintenance privacy and picket' },
              { name: 'Aluminum Fencing', href: '/services/fencing/aluminum-fencing', tag: 'Estates, pools, ornamental' },
              { name: 'Privacy Fencing', href: '/services/fencing/privacy-fencing', tag: 'Full-height solid wood or vinyl' },
              { name: 'Property Boundary', href: '/services/fencing/property-boundary', tag: 'Perimeter, lot line, farm boundary' },
              { name: 'Fence Replacement', href: '/services/fencing/fence-replacement', tag: 'Tear out old, install new, one crew' },
            ].map((s) => (
      ...
      <section className="bg-[#1a1c1a] py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold uppercase mb-14">
            Fencing Services in DeLand &amp; Volusia County
          </h2>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-[#1a1c1a] border border-white/5 p-4 text-center">
                  <p className="font-display text-2xl font-bold text-[#5d9c70]">{new Date().getFullYear() - EST_YEAR}+</p>
                  <p className="text-gray-400 text-xs uppercase tracking-wider mt-1">Years</p>
                </div>
                <div className="bg-[#1a1c1a] border border-white/5 p-4 text-center">
                  <p className="font-display text-2xl font-bold text-[#5d9c70]">{REVIEW_STATS.stars}</p>
                  <p className="text-gray-400 text-xs uppercase tracking-wider mt-1">Star Rating</p>
                </div>
                <div className="bg-[#1a1c1a] border border-white/5 p-4 text-center">
                  <p className="font-display text-2xl font-bold text-[#5d9c70]">3</p>
      ...
      {/* ═══════════════════════════════════════════
          5B. MOST SEARCHED IN FENCING (city cluster links)
          ═══════════════════════════════════════════ */}
      <section className="bg-[#0d0f0d] py-16 px-4 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <p className="text-[#c2a878] font-display uppercase tracking-[0.2em] text-sm mb-3 text-center">
            Most Searched in Fencing
          </p>
          <h2 className="font-display text-3xl font-bold uppercase text-center mb-10">
            Fencing Pages Across Central Florida
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 text-sm">
            {[
              { text: 'Fencing in DeLand', href: '/services/fencing/deland' },
              { text: 'Fencing in DeLeon Springs', href: '/services/fencing/deleon-springs' },
              { text: 'Fencing in Daytona Beach', href: '/services/fencing/daytona-beach' },
              { text: 'Fencing in Port Orange', href: '/services/fencing/port-orange' },
              { text: 'Fencing in Ormond Beach', href: '/services/fencing/ormond-beach' },
              { text: 'Fencing in Palm Coast', href: '/services/fencing/palm-coast' },
            ].map((l) => (
              <Link
                key={l.href}
                href={l.href}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div>
                <h3 className="font-display text-lg font-bold uppercase mb-1 group-hover:text-[#5d9c70] transition-colors">
                  Site Work
                </h3>
                <p className="text-gray-400 text-sm">
