  ...
  return (
    <main className="bg-[#0d0f0d] text-gray-100">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Erosion Control', url: '/services/site-work/erosion-control' },
      ]} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="relative rounded w-full h-48 overflow-hidden">
                <Image
                  src={IMAGES.site6}
                  alt="Erosion control installation"
                  fill
          ...
          <div className="grid grid-cols-2 gap-3">
            {[IMAGES.site6, IMAGES.site11].map((src, i) => (
              <div key={i} className="relative rounded w-full h-56 overflow-hidden">
                <Image
                  src={src}
                  alt={`Erosion control project ${i + 1}`}
                  fill
                  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={w.title} className="bg-[#1a1c1a] border border-[#4a7c59]/10 p-6 rounded text-center">
                <h3 className="font-display text-lg uppercase text-[#5d9c70] mb-2">{w.title}</h3>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={s.label}>
                <div className="font-display text-3xl text-[#5d9c70]">{s.val}</div>
      ...
      <SpecialtyAreaLinks service="site" specialty="Erosion Control" />
    </main>
  )
}
