                ...
                <div>
                  ...
                  <p className="font-sans text-gray-300 leading-relaxed">
                    ...
                    {sub.linkLandClearing && (
                      <> For raw-land jobs without a structure to remove, see our <Link href="/services/site-work/land-clearing" className="text-[#4a7c59] hover:underline">Land Clearing page</Link>.</>
                    )}
                  </p>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {STEPS.map((s) => (
              <div key={s.num} className="text-center">
                <div className="font-display text-5xl text-[#4a7c59] mb-3">{s.num}</div>
            ...
            {FAQS.map((f, i) => (
              <div key={i} className="border border-white/10 bg-[#141614]">
                ...
                >
                  ...
                  <span className="font-display text-[#4a7c59] text-2xl leading-none">{openFaq === i ? '−' : '+'}</span>
                </button>
                {openFaq === i && (
