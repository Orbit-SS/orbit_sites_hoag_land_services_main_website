...
export default function SiteWorkPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1a1c1a] text-white font-sans">
      ...
      {/* ═══════════════════════════════════════════
          5. DELAND LAND CLEARING PATHS
          ═══════════════════════════════════════════ */}
      <section className="bg-[#1a1c1a] py-16 px-4 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <p className="text-[#c2a878] font-display uppercase tracking-[0.2em] text-sm mb-3">
            Local Site Work
          </p>
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-8 items-start">
            <div>
              <h2 className="font-display text-3xl md:text-4xl font-bold uppercase mb-5">
                DeLand Land Clearing, Brush Clearing, and Forestry Mulching
              </h2>
              <p className="text-gray-400 leading-relaxed mb-5">
                Property owners around DeLand and DeLeon Springs often need more than a generic
                clearing crew. HLS handles brush clearing, bush-hog-style mowing, forestry
                mulching, stump grinding, grading, drainage, and full site preparation for
                build-ready lots, acreage, and overgrown fence lines.
              </p>
              <p className="text-gray-400 leading-relaxed">
                Start with the local page that matches your property, or call and we will walk
                the site before quoting the work.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                ['DeLand land clearing', '/services/site-work/deland'],
                ['DeLeon Springs site work', '/services/site-work/deleon-springs'],
                ['Daytona Beach land clearing', '/services/site-work/daytona-beach'],
                ['Land clearing service', '/services/site-work/land-clearing'],
                ['Forestry mulching', '/services/site-work/environmental-services'],
                ['Drainage and grading', '/services/site-work/drainage-grading'],
              ].map(([label, href]) => (
                <Link
                  key={href}
                  href={href}
                  className="border border-white/10 bg-[#141614] px-5 py-4 text-sm font-display font-bold uppercase tracking-wide text-white hover:border-[#4a7c59]/60 hover:text-[#c2a878] transition-colors"
                >
                  {label}
                </Link>
              ))}
      ...
      <section className="bg-[#141614] py-16 px-4 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-400 leading-relaxed max-w-3xl mb-8">
            Property owners searching for land clearing, brush clearing, and forestry mulching in DeLand need a crew
            that can walk the site, assess access and drainage, and give a real estimate before equipment moves. Start
            with the dedicated DeLand page for local permitting notes, soil context, and nearby service areas.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center border-2 border-[#4a7c59] text-[#4a7c59] hover:bg-[#4a7c59] hover:text-white font-display uppercase font-bold tracking-wider px-8 py-4 transition-colors"
            >
