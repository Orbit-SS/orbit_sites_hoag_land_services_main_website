  ...
  return (
    <main className="bg-[#0d0f0d] text-gray-100">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Land Clearing', url: '/services/site-work/land-clearing' },
      ]} />
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[IMAGES.site1, IMAGES.site7, IMAGES.site8, IMAGES.site10].map((src, i) => (
              <div key={i} className="relative rounded w-full h-40 overflow-hidden">
                <Image
                  src={src}
      ...
      <SpecialtyAreaLinks service="site" specialty="Land Clearing" />
    </main>
  )
}
