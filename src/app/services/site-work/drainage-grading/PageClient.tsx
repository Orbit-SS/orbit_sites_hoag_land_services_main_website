  ...
  return (
    <main className="bg-[#0d0f0d] text-gray-100">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Drainage & Grading', url: '/services/site-work/drainage-grading' },
      ]} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="relative rounded w-full h-48 overflow-hidden">
                <Image
                  src={IMAGES.site9}
                  alt="Grading equipment on property"
                  fill
      ...
      <SpecialtyAreaLinks service="site" specialty="Drainage & Grading" />
    </main>
  )
}
