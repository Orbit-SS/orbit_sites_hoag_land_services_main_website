                ...
                <div>
                  ...
                  <p className="font-sans text-gray-300 leading-relaxed">
                    ...
                    {sub.linkLandClearing && (
                      <> For the heavy stuff, see our <Link href="/services/site-work/land-clearing" className="text-[#579269] hover:underline">Land Clearing page</Link>.</>
                    )}
                  </p>
                </div>
              </div>
      ...
      <section className="bg-[#141614] py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="mt-8 text-center font-sans text-gray-400">
            Don&apos;t see your town?{' '}
            <Link href="/service-areas" className="text-[#579269] hover:underline">See full service area →</Link>
          </p>
        </div>
      </section>
