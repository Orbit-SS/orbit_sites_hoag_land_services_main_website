...
const SERVICE_BENEFITS: Record<string, string> = {
  ...
  'Bush Hogging & Brush Mowing':
    'Overgrown pastures, hay fields, fence lines, and acreage too rough for a lawn mower. We bring the right equipment and clear it in one pass — bush hogging, brush mowing, field mowing, vegetation management.',
  'Flooding & Drainage':
    'Standing water, washed-out driveways, soggy yards, and post-storm flooding. We find the source and install the fix — swales, French drains, culverts, and proper regrading.',
}

/* ── Service images ── */

const SERVICE_IMAGES = [IMAGES.site4, IMAGES.site7, IMAGES.site9, IMAGES.site10, IMAGES.site2, IMAGES.site11]
...
const SERVICE_SLUGS = [
  ...
  '/services/site-work/bush-hogging-brush-mowing',
  '/services/site-work/flooding-drainage',
]
...
export default function SiteWorkPage() {
  ...
  const galleryImages = [
    { src: '/photos/hoag/land-clearing-lake-shore-deland-fl.jpeg', alt: 'Hoag Land Services excavator clearing a lakeshore parcel in DeLand FL', pos: 'center 40%' },
    { src: '/photos/hoag/demolition-excavator-central-fl.jpg', alt: 'SANY mini excavator on a Central Florida demolition and site prep job' },
    { src: '/photos/hoag/bush-hogging-deland-fl.jpeg', alt: 'Skid steer bush hog clearing an overgrown DeLand lot: before and after in one frame' },
    { src: '/photos/hoag/tree-protection-zone-arborist-central-fl.jpeg', alt: 'ISA Certified Arborist tree protection zone on a Central Florida job site' },
    { src: '/photos/hoag/equipment-trailer-mobilization.jpeg', alt: 'Hoag Land Services equipment mobilization: trailer loaded and ready for the next site' },
    { src: '/photos/hoag/right-of-way-mowing-pipeline-fl.jpeg', alt: 'Brush mowing along a Central Florida right-of-way and pipeline corridor' },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#1a1c1a] text-white font-sans">
      ...
      <section className="relative min-h-[600px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-20 md:py-28">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-wide leading-tight max-w-3xl">
            Site Work Contractor in<br />DeLand &amp; Central Florida
          </h1>
          <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-2xl leading-relaxed">
            From single residential lots in DeLand to hundred-acre commercial parcels across
            Volusia, Lake, and Flagler counties: we bring the heavy equipment and expertise to
            get your land ready for what is next.
          </p>
      ...
      <section className="bg-[#141614] py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-center max-w-2xl mx-auto mb-14">
            Whether you&rsquo;re a homeowner, builder, or property owner, these problems don&rsquo;t solve themselves.
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {painPoints.map((p, i) => (
              <Link key={i} href={p.href} className="group flex gap-5 bg-[#1a1c1a] p-6 rounded-sm border border-white/5 hover:border-[#4a7c59]/40 transition-all duration-300">
                ...
                <div>
                  <h3 className="font-display text-lg font-bold uppercase mb-2 group-hover:text-[#5d9c70] transition-colors">{p.title}</h3>
                  <p className="text-gray-400 leading-relaxed text-sm mb-3">{p.desc}</p>
                  <span className="inline-flex items-center gap-1 text-[#5d9c70] text-xs font-semibold uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-opacity">
                    Learn More
      ...
      {/* ═══════════════════════════════════════════
          2B. WHAT'S INCLUDED IN SITE WORK (subservice cluster)
          ═══════════════════════════════════════════ */}
      <section className="bg-[#0d0f0d] py-16 px-4 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold uppercase text-center mb-4">
            What&rsquo;s Included in Our Site Work
          </h2>
          <p className="text-gray-400 text-center max-w-2xl mx-auto mb-12">
            Six core services in one crew. Whether you need a single subservice or full
            pad-ready site prep, here is what we run.
          </p>
      ...
      <section className="bg-[#1a1c1a] py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold uppercase mb-14">
            Site Work Services in DeLand &amp; Volusia County
          </h2>
              ...
              >
                ...
                <div className="md:w-1/2">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-[#5d9c70] font-semibold uppercase tracking-wider text-sm hover:gap-3 transition-all"
                  >
      ...
      {/* ═══════════════════════════════════════════
          5B. MOST SEARCHED IN SITE WORK (city x service cluster links)
          ═══════════════════════════════════════════ */}
      <section className="bg-[#0d0f0d] py-16 px-4 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <p className="text-[#c2a878] font-display uppercase tracking-[0.2em] text-sm mb-3 text-center">
            Most Searched in Site Work
          </p>
          <h2 className="font-display text-3xl font-bold uppercase text-center mb-10">
            DeLand &amp; Central Florida Site Work Pages
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 text-sm">
            {[
              { text: 'Land Clearing in DeLand, FL', href: '/services/site-work/deland' },
              { text: 'Land Clearing in DeLeon Springs', href: '/services/site-work/deleon-springs' },
              { text: 'Site Work in Lake Helen', href: '/services/site-work/lake-helen' },
              { text: 'Land Clearing in Pierson', href: '/services/site-work/pierson' },
              { text: 'Site Work in Daytona Beach', href: '/services/site-work/daytona-beach' },
              { text: 'Site Work in Palm Coast', href: '/services/site-work/palm-coast' },
            ].map((l) => (
              <Link
                key={l.href}
                href={l.href}
                className="bg-[#141614] hover:bg-[#1a1c1a] border border-white/5 hover:border-[#4a7c59]/40 px-4 py-3 transition-all text-[#c2a878] hover:text-white font-display uppercase tracking-wider"
              >
                {l.text} &rarr;
              </Link>
            ))}
      ...
      <section className="bg-[#141614] py-20 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mt-10">
            ...
            <a
              href={PHONE_HREF}
              className="text-[#5d9c70] font-display font-bold uppercase hover:text-[#c2a878] transition-colors"
            >
              Call us at {PHONE}
            </a>
          </div>
