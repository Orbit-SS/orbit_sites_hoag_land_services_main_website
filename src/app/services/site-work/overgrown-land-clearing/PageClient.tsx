  ...
  return (
    <main className="bg-[#0d0f0d] text-gray-100">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Overgrown Land Clearing', url: '/services/site-work/overgrown-land-clearing' },
      ]} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="relative rounded w-full h-48 overflow-hidden">
                <Image
                  src={IMAGES.site7}
                  alt="Overgrown land before clearing"
                  fill
              ...
              <div className="relative rounded w-full h-48 overflow-hidden">
                <Image
                  src={IMAGES.site8}
                  alt="Heavy equipment on overgrown lot"
                  fill
                  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                  className="object-cover"
                />
      ...
      <SpecialtyAreaLinks service="site" specialty="Overgrown Land Clearing" />
    </main>
  )
}
