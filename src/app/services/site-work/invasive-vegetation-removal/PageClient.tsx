  ...
  return (
    <main className="bg-[#0d0f0d] text-gray-100">
      <Breadcrumbs crumbs={[
        ...
        { name: 'Invasive Vegetation Removal', url: '/services/site-work/invasive-vegetation-removal' },
      ]} />
      ...
      <SpecialtyAreaLinks service="site" specialty="Invasive Vegetation Removal" />
    </main>
  )
}
